...
#' which typically occurs if the script is executed outside of the `Makefile`.
#' @return The function returns an element of the given `name` from the `params` variable that is created
