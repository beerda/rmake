...
#' @param phony Whether the recipe has a `PHONY` (i.e. non-file) target. A recipe should be marked with
...
#' @author Michal Burda
#' @export
recipe <- function(target, depends=NULL, build=NULL, clean=NULL, task='all', phony=FALSE) {
