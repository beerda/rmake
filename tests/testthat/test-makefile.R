...
test_that('1 rule makefile', {
  ...
  expect_equal(res, c('.PHONY: all',
                      ...
                      ifelse(getRversion() > '3.4.4',
                             '\t    params <- list(.target = \"Makefile\", .script = \"Makefile.R\", .depends = NULL, .task = \"all\")',
                             '\t    params <- structure(list(.target = \"Makefile\", .script = \"Makefile.R\", .depends = NULL, .task = \"all\"), .Names = c(\".target\", \".script\", \".depends\", \".task\"))'),
                      '\t    source("Makefile.R")',
                      '\t}',
                      '\tEOFrmake'))
})
...
test_that('custom vars in makefile', {
  ...
  if (.Platform$OS.type == 'unix') {
    expect_equal(res, c('# This file is generated by rmake - do not edit by hand',
