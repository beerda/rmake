...
The package requires the `R_HOME` environment variable to be properly set. This is automatically set when running from within R or RStudio. To run make outside of R:
