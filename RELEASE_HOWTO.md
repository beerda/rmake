...
- Update Github actions: usethis::use_github_action(“check-standard”)
...
- Release: devtools::release(args = “–compact-vignettes=both”)
- After release:
  - commit CRAN-SUBMISSION and make GIT tag & release
- Prepare for next development iteration:
  - Search for deprecate_stop() and consider if you’re ready to the
