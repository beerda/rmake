...
- released: 2026-09-25
- added pythonRule()
- fixed markdownRule() to properly generate the resulting PDF if the
  output is to a different directory than the source Rmd file
...
- added depRule()
- enabled the depends argument of makefile() that allows the makefile
  generator to depend on other files
...
- released: 2018-03-29
- initial version supporting rules for R script, R Markdown and offline
  rules
