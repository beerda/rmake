...
#> [31] "\t        rmarkdown::render(\"report.Rmd\", output_format = targets[[tg]], output_dir = dirname(tg), output_file = basename(tg))" 
#> [32] "\t    }"                                                                                                                          
#> [33] "\t}"                                                                                                                              
#> [34] "\tEOFrmake"                                                                                                                       
...
#> [41] "\t        rmarkdown::render(\"details.Rmd\", output_format = targets[[tg]], output_dir = dirname(tg), output_file = basename(tg))"
#> [42] "\t    }"                                                                                                                          
#> [43] "\t}"                                                                                                                              
#> [44] "\tEOFrmake"                                                                                                                       
#> [45] ".PHONY: clean"                                                                                                                    
