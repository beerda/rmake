...
#> [10] ""                                                                                                              
#> [11] ".PHONY: all"                                                                                                   
#> [12] "all: Makefile something.abc"                                                                                   
#> [13] "\t"                                                                                                            
#> [14] "something.abc: file.a file.b file.c"                                                                           
#> [15] "\tmyCompiler file.a file.b file.c -o something.abc"                                                            
#> [16] ".PHONY: clean"                                                                                                 
#> [17] "clean: "                                                                                                       
#> [18] "\t$(RM) something.abc"                                                                                         
#> [19] "Makefile: Makefile.R"                                                                                          
#> [20] "\t$(R) - <<'EOFrmake'"                                                                                         
#> [21] "\t{"                                                                                                           
#> [22] "\t    params <- list(.target = \"Makefile\", .script = \"Makefile.R\", .depends = NULL, .task = \"all\")"      
#> [23] "\t    source(\"Makefile.R\")"                                                                                  
#> [24] "\t}"                                                                                                           
#> [25] "\tEOFrmake"                                                                                                    
