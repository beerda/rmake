...
#> [10] ""                                                                                                                                     
#> [11] ".PHONY: all"                                                                                                                          
#> [12] "all: Makefile cleandata.csv"                                                                                                          
#> [13] "\t"                                                                                                                                   
#> [14] "cleandata.csv: clean.R data1.csv data2.csv"                                                                                           
#> [15] "\t$(R) - <<'EOFrmake'"                                                                                                                
#> [16] "\t{"                                                                                                                                  
#> [17] "\t    params <- list(.target = \"cleandata.csv\", .script = \"clean.R\", .depends = c(\"data1.csv\", \"data2.csv\"), .task = \"all\")"
#> [18] "\t    source(\"clean.R\")"                                                                                                            
#> [19] "\t}"                                                                                                                                  
#> [20] "\tEOFrmake"                                                                                                                           
#> [21] ".PHONY: clean"                                                                                                                        
